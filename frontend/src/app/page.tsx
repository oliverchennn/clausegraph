...
import type { Action, DraftResponse, IntakeRequest, PlanRequest, PlanResult, ProviderStatus, RuleReview, UploadResponse, VerificationResult, Workspace } from "@/lib/types";
...
export default function Home() {
  ...
  useEffect(() => { setVerification(null); }, [workspace?.session_id, workspace?.revision, workspace?.plan?.id]);
  useEffect(() => {
