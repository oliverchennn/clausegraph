...
Integrated PR39 main 96b220e5c4298df83a822846cb13e1dfbb234c86 by normal merge before publication. It changes only coordination/design/delivery documentation; the tested frontend and backend trees are unchanged. Current-main ownership/handoff/conflict checks and managed pre-push passed. The required solo reassignment and reviewed design are now on main.
